  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-20">
      <div className="flex items-center gap-4">
        <button onClick={() => navigate(-1)} className="p-3 bg-white border border-gray-200 rounded-2xl text-gray-500 hover:text-gray-900 hover:bg-gray-50 hover:shadow-sm transition-all">
          <ArrowLeft size={20} />
        </button>
        <div>
          <h1 className="text-2xl font-black text-gray-900 tracking-tight">Shipment Details</h1>
          <p className="text-gray-500 text-sm">Order #{order._id.toUpperCase()}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-gray-200 p-8 rounded-[2.5rem] shadow-sm relative overflow-hidden">
            ...
            <h3 className="text-gray-900 font-bold text-lg mb-6">Execution</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 p-4 rounded-2xl border border-gray-100">
                ...
                <p className="text-gray-900 font-bold text-sm uppercase tracking-widest">{order.paymentMethod}</p>
                <p className="text-green-600 text-[10px] font-black uppercase mt-1 tracking-widest">{order.isPaid ? 'Already Paid' : 'Collect Cash'}</p>
              </div>
            </div>
          ...
          {/* Timeline */}
          <div className="bg-white border border-gray-200 p-8 rounded-[2.5rem] shadow-sm">
            <h3 className="text-gray-900 font-bold text-sm mb-6 uppercase tracking-widest">Tracking Log</h3>
            <div className="space-y-6">
